...
var file_mdb_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x22, 0xb4, 0x01, 0x0a, 0x07, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x12, 0x12,
	...
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x21, 0x0a, 0x03, 0x75, 0x73, 0x65, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x0f, 0x2e, 0x6d, 0x64, 0x62, 0x2e, 0x4d, 0x61, 0x63, 0x68, 0x69, 0x6e,
	0x65, 0x55, 0x73, 0x65, 0x52, 0x03, 0x75, 0x73, 0x65, 0x22, 0x29, 0x0a, 0x13, 0x4c, 0x69, 0x73,
...
var file_mdb_proto_depIdxs = []int32{
	...
	5, // 1: mdb.Mdb.machines:type_name -> mdb.Machine
	3, // 2: mdb.Mdb.config:type_name -> mdb.Config
	0, // 3: mdb.Machine.type:type_name -> mdb.MachineType
	1, // 4: mdb.Machine.use:type_name -> mdb.MachineUse
	5, // 5: mdb.ListMachinesResponse.machines:type_name -> mdb.Machine
	0, // 6: mdb.UpdateMachineRequest.new_type:type_name -> mdb.MachineType
	6, // 7: mdb.MDBService.ListMachines:input_type -> mdb.ListMachinesRequest
	8, // 8: mdb.MDBService.UpdateMachine:input_type -> mdb.UpdateMachineRequest
	7, // 9: mdb.MDBService.ListMachines:output_type -> mdb.ListMachinesResponse
	9, // 10: mdb.MDBService.UpdateMachine:output_type -> mdb.UpdateMachineResponse
